      ...
      <div style={styles.header}>
        <div style={styles.headerTop}>
          ...
          <button
            style={{
              ...styles.timeBtn,
              background: showTimePicker || timeOffset !== "now"
                ? "rgba(168,85,247,0.2)"
        ...
        <div style={styles.subtitle}>
          San Luis Obispo · {timeOffset === "now" ? "Right now" : `Forecast in ${timeOffset} min`}
        </div>
            ...
            <div style={styles.timeOptionsRow}>
              {TIME_OPTIONS.map((t) => (
                <button
                  ...
                  onClick={() => { setTimeOffset(t); setShowTimePicker(false); }}
                >
                  {t === "now" ? "NOW" : `+${t}m`}
                </button>
              ))}
          ...
          return (
            ...
            >
              ...
              <div style={styles.cardStats}>
                ...
                <div className="stat-chip">💵 {bar.cover === 0 ? "Free" : `$${bar.cover}`}</div>
              </div>
...
const styles = {
  ...
  subtitle: { 
    fontSize: 13, color: "rgba(255,255,255,0.35)", fontWeight: 300, letterSpacing: "0.5px" },
  timePicker: {
    marginTop: 14, background: "rgba(255,255,255,0.04)",
    border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 14,
  },
  timePickerLabel: { fontSize: 10, fontWeight: 700, letterSpacing: "2px", color: "rgba(255,255,255,0.28)", marginBottom: 10 },
  timeOptionsRow: { display: "flex", gap: 8 },
  timeOption: {
    flex: 1, padding: "8px 4px", borderRadius: 10, fontSize: 12, fontWeight: 700,
    letterSpacing: "0.5px", cursor: "pointer", fontFamily: "var(--font-display)", transition: "all 0.15s",
    WebkitTapHighlightColor: "transparent",
  },
  barList: { overflowY: "auto", padding: "4px 16px 100px", scrollbarWidth: "none" },
  barCard: {
  ...
  barName: { fontFamily: "var(--font-display)", fontSize: 22, letterSpacing: "1.5px", color: "#fff", lineHeight: 1 },
  friendsPreview: { display: "flex", alignItems: "center" },
  friendAvatarSm: {
    width: 24, height: 24, borderRadius: "50%",
    background: "linear-gradient(135deg, #a855f7, #ec4899)",
    border: "2px solid #080810", display: "flex", alignItems: "center",
    justifyContent: "center", fontSize: 9, fontWeight: 600, marginLeft: -6, color: "white",
  },
  friendsCount: { fontSize: 11, color: "#a855f7", fontWeight: 600, marginLeft: 8 },
  cardStats: { display: "flex", gap: 6, flexWrap: "wrap" },
  cardBottom: {
  ...
  worthBadge: { fontFamily: "var(--font-display)", fontSize: 14, letterSpacing: 1, padding: "3px 10px", borderRadius: 20 },
  lockedBadge: {
